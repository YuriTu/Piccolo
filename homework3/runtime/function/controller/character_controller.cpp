...
namespace Pilot
{
    ...
    Vector3 CharacterController::move(const Vector3& current_position, const Vector3& displacement)
    {
        ...
        // Vector3 vertical_up_displacement   = displacement.z * Vector3::UNIT_Z * -1;

        Vector3 vertical_direction   = vertical_displacement.normalisedCopy();
        // Vector3 vertical_up_direction   = vertical_up_displacement.normalisedCopy();
        ...
        //     m_rigidbody_shape,
        //     world_transform.getMatrix(),
        //     vertical_up_direction,
        //     vertical_up_displacement.length(),
        //     hits))
        // {
        //     final_position += hits[0].hit_distance * vertical_up_direction;
        // }
        // else
        // {
        //     final_position += vertical_up_displacement;
        // }
